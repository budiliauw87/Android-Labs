...
fun AppBackup(
    ...
    AppTheme(
        ...
        var isShowButton by remember { mutableStateOf(true) }

        LaunchedEffect(selectedDestination){
            isShowButton = Destination.entries[selectedDestination].route == Destination.HOME.route
            val currentRoute = Destination.entries[selectedDestination].route
            AppLogger.d("Side Effect", "selectedDestination: $currentRoute")
        }
        LaunchedEffect(Unit){
